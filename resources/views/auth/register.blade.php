        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 flex items-center pr-4">
                    <svg id="eye-icon" class="w-5 h-5 text-gray-400 hover:text-gray-600 transition-colors" fill="none"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePassword('password_confirmation', 'eye-icon-confirm')"
                    ...
                    <svg id="eye-icon-confirm" class="w-5 h-5 text-gray-400 hover:text-gray-600 transition-colors"
