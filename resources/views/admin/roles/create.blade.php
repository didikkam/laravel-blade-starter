    ...
    <nav class="flex justify-between items-center" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class="fas fa-chevron-right text-base text-gray-400 mx-2 align-middle"></i>
                    <span class="text-sm font-medium text-gray-500 ml-2">Create Role</span>
                </div>
            </li>
        </ol>
        <a href="{{ route('admin.roles.index') }}"
...
@section('content')
    <div class="p-6 bg-white rounded-lg shadow">
        ...
        <p class="text-gray-600 mb-6">Fill in the details to create a new role</p>
        ...
        <form id="createRoleForm" class="space-y-6">
            ...
            <button type="submit"
                ...
                <span class="flex items-center justify-center">
                    ...
                    <span id="button-text">Create Role</span>
                </span>
            </button>
        </form>
    </div>
