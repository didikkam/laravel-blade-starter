        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="text-sm font-medium text-gray-500 ml-2">Roles</span>
                </div>
            </li>
        </ol>
    </nav>
...
<div class="bg-white rounded-lg shadow-sm">
    <div class="p-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('admin.roles.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
            ...
            columns: [
                ...
                { 
                    ...
                    render: function(data, type, row) {
                        const showUrl = "{{ route('admin.roles.show', ':id') }}".replace(':id', row.id);
                        const editUrl = "{{ route('admin.roles.edit', ':id') }}".replace(':id', row.id);
